        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            CAR_STATE carState;
          	...
          	carState.s = j[1]["s"];
          	carState.d = j[1]["d"];
          	carState.yaw_r = j[1]["yaw"];
            carState.yaw_d = deg2rad(j[1]["yaw"]);
          	carState.v = j[1]["speed"];
            ...
            auto next_vals = planner.generateTrajectory(carState, previous_path, sensor_fusion);
